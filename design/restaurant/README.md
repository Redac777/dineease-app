...
## Règles
- **Un fichier par version, daté** : `restaurant-<interface>-AAAA-MM-JJ.<ext>`.
...
- La maquette **adoptée** (celle qui fait foi) est notée dans `docs/specs/restaurant/design.md`.

## Fichiers
<!-- ex.
- restaurant-liste-2026-07-06.html  ← adoptée
- restaurant-detail-2026-07-06.png
-->
