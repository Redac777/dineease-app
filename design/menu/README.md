...
## Règles
- **Un fichier par version, daté** : `menu-<interface>-AAAA-MM-JJ.<ext>`.
...
- La maquette **adoptée** (celle qui fait foi) est notée dans `docs/specs/menu/design.md`.

## Fichiers
<!-- ex.
- menu-liste-2026-07-06.html  ← adoptée
- menu-detail-2026-07-06.png
-->
