...
## Règles
- **Un fichier par version, daté** : `kitchen-<interface>-AAAA-MM-JJ.<ext>`.
...
- La maquette **adoptée** (celle qui fait foi) est notée dans `docs/specs/kitchen/design.md`.

## Fichiers
<!-- ex.
- kitchen-liste-2026-07-06.html  ← adoptée
- kitchen-detail-2026-07-06.png
-->
