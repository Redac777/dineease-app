...
## Rôle
Le tenant : onboarding du restaurant, nom, logo, generation du theme, isolation multi-restaurant.
...
## Où est quoi
- Spec : `docs/specs/restaurant/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/restaurant/`
