...
## Rôle
Vue serveur (Premium) : commandes a livrer, passage en livre, liberation de la table.

- **Owner** : @Redac777
- **Dépendances autorisées** : kitchen (via leur API publique `index.ts` uniquement)
...
## Où est quoi
- Spec : `docs/specs/service/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/service/`
