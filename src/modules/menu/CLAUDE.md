...
## Rôle
Sections et plats du restaurant (nom, description, image, note, recommande, best-seller, temps de preparation).
...
## Où est quoi
- Spec : `docs/specs/menu/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/menu/`
