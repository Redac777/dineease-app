...
## Rôle
Super-admin : gestion des restaurants et de leur licence.
...
## Où est quoi
- Spec : `docs/specs/platform/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/platform/`
