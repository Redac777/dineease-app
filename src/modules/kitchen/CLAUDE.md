...
## Rôle
Vue cuisine : workflow des statuts de commande et alerte vocale au service.

- **Owner** : @Redac777
- **Dépendances autorisées** : ordering (via leur API publique `index.ts` uniquement)
...
## Où est quoi
- Spec : `docs/specs/kitchen/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/kitchen/`
